//Function for robots robot has name battery toys
// function for kids has name wishlist location
// create robots create kids can robot deliver?  (delivery requires 5 batterires)
// deliver toys deliver to all kids get waiting kids get totall toys needed for everyone
// get total toys needed for everyone  deliver based on locaation
